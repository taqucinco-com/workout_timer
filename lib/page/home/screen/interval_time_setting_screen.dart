...
class IntervalTimeSettingScreen extends HookConsumerWidget {
  const IntervalTimeSettingScreen({super.key});
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final pendingDuration = useState(Duration());
    ...
    void toNext() {
      workoutStateUsecase.transferToRoundSet(IntervalDurationSet(pendingDuration.value));
    }
